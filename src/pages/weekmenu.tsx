...
<<<<<<< HEAD
    <SubPage title="Weekmenu" image="https://users.ugent.be/~psoubrie/images/test_1.png">
      ...
      <h2 className="text-2xl mt-5 text-primary">DINSDAG</h2>
      ...
      proident.
      <h2 className="text-2xl mt-5 text-primary">WOENSDAG</h2>
      ...
      exercitation.
      <h2 className="text-2xl mt-5 text-primary">DONDERDAG</h2>
      ...
      <h2 className="text-2xl mt-5 text-primary">VRIJDAG</h2>
...
=======
    <SubPage title="Weekmenu" image="/images/bg/doorklik/weekmenu.png">
      ...
      <ul className="list-square space-y-3">
        <li>
          ...
          <br /> Wrap it up tight and you&apos;re good to go, that&apos;s the
          truth
        ...
        <li>
          Vandaag eten we overheerlijke wok! Dankzij WWF maken we een duurzame
          en overheerlijke maaltijd!
          <br /> <br />
          <Accordion
            sx={{
              boxShadow: "none",
          ...
          >
            ...
            <AccordionDetails>
              De sojascheuten, die we in onze wok verwerken, zijn een pluspunt
              voor de planeet. Ze zijn de kiemen van de mungboon, niet van
              sojabonen zoals de naam doet vermoeden. De mungboon is een
              peulvrucht die vooral in Azië wordt geteeld. Zoals alle
              peulvruchten bindt de boon stikstof uit de lucht, die hij als
              voedingsstof gebruikt. Als gevolg daarvan heeft ze over het
              algemeen minder (of geen) bemesting nodig. Peulvruchten worden
              vaak gebruikt als groenbemesting, omdat ze de bodem op natuurlijke
              wijze verrijken met stikstof die in een volgend vegetatie seizoen
              door de gewassen kan worden opgenomen.
            </AccordionDetails>
          </Accordion>
          <br /> Door wokgroenten te mengen met lokale groenten is het een
          gezonde, duurzame en verfrissende groentenmix!
        </li>
      </ul>
      <hr className="my-3" />
      <h2 className="mt-5 font-subTitle text-2xl tracking-normal text-primary ">
      ...
      <ul className="list-square space-y-3">
        <li>
          ...
          <br /> Een perfecte aanvulling voor elke zomerse maaltijd in alle
          pracht.
        </li>
        <li>
          Een lekkernij, zoet en zacht
        ...
        <li>
          ...
          vriendelijke sympathieke bediening. We komen hier zeker terug” -
          FilipW578
          <br /> <br />
          “Verdomme … dat was goed om je vingers bij af te likken! Alles wat op
          tafel werd gezet zag er fantastisch uit en smaakte nog beter. Je
          proeft echt dat alles supervers is! Geen reden om je in te houden!” -
          FlavieV17
        </li>
      </ul>
      <hr className="my-3" />
      ...
      <ul className="list-square space-y-3">
        <li>
          Wist je dat … mijn naam afkomstig is van een Grieks gegist
          gerstendrankje?
          <br /> Wist je dat ik in het Engels vernoemd ben naar een Britse graaf
          die een grote fan was van kapitein James Cook?
          <br /> Wist je dat de bereidingswijze van deze zetmeelbron is
          uitgevonden in Oostenrijk in de 19e eeuw?
        </li>
        <li>
          We zijn halfweg! Daarom, om jullie een hart onder de riem te steken
          voor het vervolg van de week, bieden we een energieke koek op basis
          van amandelen aan. De tweede helft is van ons, we gaan nog pieken!
          <br />
          <br />
          <Image
            src="/images/raadsel.png"
            width={600}
            height={200}
            alt="raadsel"
          />
        ...
        <li>
          ¡El chili sin carne es la cosa más deliciosa que existe! Pero cuidado,
          los frijoles pueden hacer que te tires un pedo... no te preocupes si
          los demás se tiran pedos, ¡no te avergüences!
        </li>
      </ul>
      <hr className="my-3" />
      <h2 className="mt-5 font-subTitle text-2xl tracking-normal text-primary ">
      ...
      <ul className="list-square space-y-3">
        <li>
          Vandaag eten we een maaltijd, maar niet op het juiste moment.
          <br /> We eten het &apos;s middags, al is het meer voor &apos;s
          ochtends gekend.
          ...
          >
            ...
            <AccordionDetails>
              <ul className="ml-2 list-square">
                <li>
                  Top voor je gezondheid: De Inca&apos;s gaven hun strijders
                  quinoa te eten om hen meer kracht, uithoudingsvermogen en
                  energie te geven. Deze zaadjes zijn zeer rijk aan vezels. Het
                  is een fantastische bondgenoot voor je gezondheid, want quinoa
                  verbetert de kwaliteit van het bloed en bevat onder meer koper
                  en zink. De vezels verbeteren de darmtransit en de eiwitten
                  verbeteren de kwaliteit van de huid, botten, pezen en spieren.
                  Dit recept is een ideale start voor een dag in topconditie.
                  Bovendien verbetert de pompoen bepaalde functies van het
                  immuunsysteem door zijn antioxidante werking. Deze groente is
                  ook rijk aan bètacaroteen, een plantaardig pigment dat de huid
                  en de ogen helpt te beschermen.
                </li>
                <li className="mt-3">
                  Top voor de planeet: Zowel pompoen als quinoa groeien in
                  België, dit slaatje is dus lekker lokaal. Bovendien zitten er
                  enkel seizoensgroentjes in!
                </li>
              </ul>
            </AccordionDetails>
          </Accordion>
        ...
        <li>
          ...
          >
            ...
            <AccordionDetails>
              ...
              Ideaal als gezonde tussendoor dus om er vandaag nog even tegenaan
              te kunnen. We zijn er bijna!
            </AccordionDetails>
          </Accordion>
        </li>
        <li>
